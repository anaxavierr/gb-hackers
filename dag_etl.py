...
GS_CONN_ID = 'google_cloud_storage_default'
BQ_LOCATION = 'us-east1'
BQ_DATASET_NAME = 'gb-project-385603.Vendas.base_17_18_19'
...
delete_bigquery_table = BigQueryDeleteTableOperator(
    ...
    deletion_dataset_table=f"{PROJECT_ID}.{BQ_DATASET_NAME}.{TABLE_NAME}",
    project_id=PROJECT_ID,
    dataset_id=BQ_DATASET_NAME,
    table_id=TABLE_NAME,
    bigquery_conn_id=BQ_CONN_ID,
...
load_data_to_bigquery = GCSToBigQueryOperator(
    ...
    field_delimiter=',',
    bigquery_conn_id=BQ_CONN_ID,
    google_cloud_storage_conn_id=GS_CONN_ID,
    location=BQ_LOCATION,
    dag=dag,
)

# Tarefa para executar as transformações no BigQuery
transform_data_in_bigquery_1 = GCSToBigQueryOperator(
...
transform_data_in_bigquery_2 = GCSToBigQueryOperator(
...
transform_data_in_bigquery_3 = GCSToBigQueryOperator(
...
transform_data_in_bigquery_4 = GCSToBigQueryOperator(
...
create_bigquery_table >> load_data_to_bigquery
